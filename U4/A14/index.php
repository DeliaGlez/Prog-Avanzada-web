          ...
          <div class="row row-cols-1 row-cols-md-3 g-4 py-5">
            <?php if ($products && isset($products['data'])): ?>
                <?php foreach ($products['data'] as $product): ?>
                  <div class="col">
                    <div class="card ">
                      <img src="<?= htmlspecialchars($product['cover']); ?>" class="card-img-top img-fluid w-100 h-100" alt="<?= htmlspecialchars($product['name']); ?>" />
                      <div class="card-body">
                        <h5 class="card-title"><?= htmlspecialchars($product['name']); ?></h5>
                        <h6 class="card-text">Precio: $<?= htmlspecialchars($product['presentations'][0]['price'][0]['amount']);?></h6>
                        <p class="card-text"><?= htmlspecialchars($product['description']); ?></p>
                        <a href="details.php?id=<?= $product['id']; ?>" class="btn btn-primary">Ver detalles</a>
                      </div>
                    </div>
                  </div>
                <?php endforeach; ?>
