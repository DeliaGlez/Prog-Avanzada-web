    ...
    <div class="card my-5 mx-3">
        <div class="card-body">
            ...
            <form method="POST" action="auth">
                <div class="mb-3">
                    <input type="email" name="correo" class="form-control" id="floatingInput" placeholder="Email Address" required>
                </div>
                <div class="mb-3">
                    <input type="password" name="contrasenia" class="form-control" id="floatingInput1" placeholder="Password" required>
                </div>
