        ...
        <div class="navbar-content">
          <ul class="pc-navbar">
            ...
            <li class="pc-item pc-hasmenu">
              ...
              <ul class="pc-submenu">
                <li class="pc-item"><a class="pc-link" href="<?= BASE_PATH ?>home">Analytics</a></li>
            ...
            <li class="pc-item pc-hasmenu">
              ...
              <li class="pc-item"><a class="pc-link" href="<?= BASE_PATH ?>products">Product</a></li>
                ...
                <li class="pc-item"><a class="pc-link" href="<?= BASE_PATH ?>products/create">Add New Product</a></li>
